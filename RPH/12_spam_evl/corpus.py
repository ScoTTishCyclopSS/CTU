...
class Corpus:
    ...
    def emails(self):
        for file in os.listdir(self.direct):  # by function listdir - we create the list with everything that this direction has
            ...
            file_path = os.path.join(self.direct, file)
