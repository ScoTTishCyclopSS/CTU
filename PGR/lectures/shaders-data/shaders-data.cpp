...
bool init() {
	...
	glBindVertexArray(resources.vao); // -> now object is done
	// generate and initialize the vertex buffer object -> variable resources.vbo
	glGenBuffers(1, &resources.vbo);
	glBindBuffer(GL_ARRAY_BUFFER, resources.vbo); // -> now object is done
	// transfer data
	...
	glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, resources.ebo); // -> now object is done
	// transfer data
	...
	glVertexAttribPointer(handles.position, 3, GL_FLOAT, GL_FALSE, 0, (void*)0);
	...
	glVertexAttribPointer(handles.aNextPosition, 3, GL_FLOAT, GL_FALSE, 0, (void*)0);
