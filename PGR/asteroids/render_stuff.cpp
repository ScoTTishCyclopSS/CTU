...
// ======== BEGIN OF SOLUTION - TASK 1_2-4 ======== //
  // Create VAO and VBO for ufo vertices and colors
// ========  END OF SOLUTION - TASK 1_2-4  ======== //

// ======== BEGIN OF SOLUTION - TASK 1_3-4 ======== //
  // Create buffer for indices and copy the index array to it 
// ========  END OF SOLUTION - TASK 1_3-4  ======== //

// ======== BEGIN OF SOLUTION - TASK 1_2-5 ======== //
  // Enable attribute arrays and specify the data format of vertex attributes at position and color 
// ========  END OF SOLUTION - TASK 1_2-5  ======== //
